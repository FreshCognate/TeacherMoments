...
const TriggerStemsItem = ({
  ...
  return (
    <div>
      ...
      {(slideStemItem) && (
        <div>
          {map(slideStemItem.conditions, (condition, index) => {
            return (
              <Fragment key={condition._id || index}>
                ...
                <div className="rounded-md overflow-hidden">
                        ...
                        <div key={prompt._id || index} className="flex items-start justify-between bg-lm-2 dark:bg-dm-2 mb-0.5 p-4 last:border-b-0">
                          ...
                          <div className="w-1/2">
                            <div className="flex w-full items-center">
                              ...
                              <FlatButton icon="edit" onClick={() => onEditPromptConditionClicked({ elementRef: slideStemItem.elementRef, prompt, condition })} />
                            </div>
                          </div>
                        </div>
                      );
                  ...
                  <div className="min-w-10 flex justify-end p-2 bg-lm-2 dark:bg-dm-2">
                    <FlatButton title="Delete condition" icon="delete" onClick={() => onRemoveConditionClicked({ elementRef: slideStemItem.elementRef, conditionId: condition._id })} />
                  </div>
                </div>
              </Fragment>
            );
      ...
      {(!slideStemItem || slideStemItem.conditions.length === 0) && (
        <div>
...
export default TriggerStemsItem;