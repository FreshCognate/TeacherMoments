const LandingTestimonial = () => {
  return (
    <section className="bg-[#f6f6ee] py-20 px-6">
      <div className="max-w-3xl mx-auto">
        <figure className="flex gap-3 md:gap-6">
          <span className="text-6xl md:text-8xl font-black text-[#174650] leading-none shrink-0" aria-hidden="true">&ldquo;</span>
          <div>
            <blockquote className="text-xl md:text-2xl lg:text-3xl leading-relaxed text-[#174650] mb-6 bg-transparent border-l-0 p-0">
            ...
            <figcaption className="text-[#174650]">
