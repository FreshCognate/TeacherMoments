...
const LandingFooter = () => {
  return (
    <footer className="bg-[#f6f6ee] dark:bg-[#18181b] py-12 px-6">
      <div className="max-w-6xl mx-auto">
        <div className="flex flex-col md:flex-row items-center gap-4 md:gap-6 mb-8">
          <div className="flex items-center gap-2">
            ...
            <span className="text-lg font-black text-[#174650] dark:text-[#e3efef]">Teacher<br />Moments</span>
          </div>
          <span className="text-[#174650]/30 dark:text-[#e3efef]/30 text-2xl font-light hidden md:inline" aria-hidden="true">|</span>
          ...
          <a href="https://tsl.mit.edu/" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2">
            ...
            <span className="text-sm font-semibold text-[#174650] dark:text-[#e3efef] leading-tight">MIT Teaching<br />Systems Lab</span>
          </a>
        </div>
        <ul className="grid grid-cols-2 gap-x-12 gap-y-3 max-w-sm mx-auto md:mx-0">
          {links.map((link) => (
            <li key={link.label}>
              <a
                href={link.href}
                className="!text-black dark:!text-[#e3efef] underline hover:opacity-80"
                target="_blank"
