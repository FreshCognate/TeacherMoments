...
const TextFormField = ({ value, schema, updateField }) => {
  return (
    <input
      ...
      className="border border-lm-3 py-1 px-2 text-sm bg-lm-1 dark:bg-dm-1 dark:border-dm-3 rounded w-full focus:outline-2 outline-primary-regular dark:outline-primary-light outline-offset-1"
